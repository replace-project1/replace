...
<link rel="stylesheet" href="../../static/css/info/siteInfo.css">
			...
			<div class="services__wrapper_outer common__wrapper">
				<div class="services_wrapper_inner">
					...
					<div class="services__item">
						...
						<p class="services__item__description">개인화된 공고를 매칭해주는 AI 기반
							글로벌 채용 서비스 ‘SPOTLIGHT’를 통해 해외에서도 35만 인재와 1,800개의 기업이 함께 하고 있습니다.</p>
					</div>
				</div>
			</div>
			...
			<div class="contacts__wrapper common__wrapper">
				...
				<div class="contacts__button__wrapper">
					<a href="https://wbc.oopy.io/companyprofile"
						class="contacts__button__base contacts__button__download">회사
						소개 자료 보기</a> <a href="https://wantedlab.irpage.co.kr/#/main"
	...
	<footer id="footer">
		<div class="footer__wrapper common__wrapper hide__sm">
            ...
            "
						...
						src="https://www.wantedlab.com/img/footer_icon_fb.png"
						width="20px" height="auto" alt="페이스북 링크 아이콘">
			...
			<div class="footer__section">
				<div>
					<p class="footer__address">
						(주)Replace<br> 팀장:alert-Enoch - 최에녹 | 부팀장:dev-PatrickLee -
						이승환 <br> 팀원: dev-aprilchoi - 최유라, dev-HJ0309 - 주현진,
		...
		<div class="footer__wrapper common__wrapper show__sm">
			<div class="footer__section" style="margin-top: 0; height: 92px">
				<img src="../../static/images/logo.png"
					width="200px" height="100px" alt="원티드 회사 로고">
			</div>
			...
			<div class="footer__section" style="margin-bottom: 20px">
				<div class="footer_section__icons">
					<a href="https://www.instagram.com/wantedjobs.kr/"><img
						...
						alt="유튜브 링크 아이콘"> </a><a
						href="https://www.facebook.com/wantedkr"><img
						src="img/footer_icon_fb.png" width="20px" height="auto"
						alt="페이스북 링크 아이콘"> </a><a
						href="https://blog.naver.com/wantedlab"><img
