...
<body>
	<div id="__next">
		<div class="NavBar_className" style="position: fixed;"
			role="presentation">
							...
							<li>
								<button type="button" class="searchButton">
									<svg xmlns="https://www.w3.org/2000/svg"
                                        ...
                                        <g fill="none"
											fill-rule="evenodd">
                                            <use fill="#333" fill="#333"
											stroke="#333" stroke-width=".3" xlink:href="#qt2dnsql4a"></use>
                                        </g>
                                    </svg>
								</button>
							</li>
		...
		<div class="Container_Profile">
			...
			<div class="MatchUp_className">
				<aside class="Aside Aside_className">
					<header class="Aside-header">
						<div class="Aside-avatar">
							<div
								class="Avatar_Avatar__root Avatar_Avatar__sizeMedium Aside-avatar_image">
								<img
						...
						<a
							...
							class="Aside-edit" target="_blank" rel="noopener noreferrer">기본정보
							수정</a>
					</header>
					<div class="MatchUpStatus MatchUpStatus_className">
						<a
							href="https://www.wanted.co.kr/profile/status?type=matchup-likes"
							class="MatchUpStatus-item"> <span class="MatchUpStatus-label">관심
								있음</span> <strong class="MatchUpStatus-value">0</strong>
						</a> <a
							href="https://www.wanted.co.kr/profile/status?type=matchup-opens"
							class="MatchUpStatus-item"> <span class="MatchUpStatus-label">열람</span>
							<strong class="MatchUpStatus-value">0</strong>
						</a> <a
							href="https://www.wanted.co.kr/profile/status?type=matchup-offers"
							class="MatchUpStatus-item"> <span class="MatchUpStatus-label">받은
								제안</span> <strong class="MatchUpStatus-value">0</strong>
						</a>
					</div>
				...
				<section>
					<aside
						class="CareerConnectBanner_CareerConnectBanner MatchUp_CareerConnectBanner">
						<picture>
						<source
						...
						<button type="button"
							...
							<div
								class="CareerConnectBanner_CareerConnectBanner__Banner__Content CareerConnectBanner_CareerConnectBanner__Banner__Content__Trio">
								<p>이력서 작성이 쉬워진다!</p>
								<strong>내 경력 불러오기</strong>
								<picture>
								<source
									srcset="https://static.wanted.co.kr/career_connect/trio2.webp"
									type="image/webp">
								<img src="src="
									https://static.wanted.co.kr/career_connect/trio2.png"" alt="career-connect-icon">
								</picture>
							</div>
						</button>
					</aside>
					<div>
						<div
							class="MatchUpForm Form_className ResumeWordCountWarning_className">
							<div class="ResumeWordCountWarning-body">
								<p class="ResumeWordCountWarning-count is-invalid">
									이력서 글자 수 : <span class="current_char">90자</span> / 최소 400자
								</p>
								<p class="ResumeWordCountWarning-guide">글자 수가 400자 이상이면, 직접
									제안받을 확률이 높아집니다.</p>
							</div>
							<a
								href="https://www.wanted.co.kr/cv/BQIFDAMDAU8DAQICAAAETUQ=?from=profile"
								class="ResumeWordCountWarning-button">이력서 강화하기</a>
						</div>
							...
							<div class="FormBlock Block_className">
								<div class="FormBlock-content content">
										...
										<div class="Static-body">
											<div class="DefaultResumeSelector_className">
												<button type="button" class="DefaultResumeSelector-button">
													<div
														class="ResumeLang_container DefaultResumeSelector-resumeLang">한</div>
													<span>최유라 1</span>
												</button>
											</div>
										</div>
									...
									<div class="MainResume-fieldset">
										<div class="Static_className">
											...
											<div class="Static-body">
												<div class="ResumeEntry_className">
													<span class="ResumeEntry-major">연세대학교</span> <span
														class="ResumeEntry-minor is-empty"> 전공 미입력 </span>
												</div>
											</div>
										</div>
										<div class="Static_className">
											...
											<div class="Static-body">
												<div class="ResumeEntry_className">
													<span class="ResumeEntry-major">신입</span> <span
										...
										<a
											href="https://www.wanted.co.kr/cv/BQIFDAMDAU8DAQICAAAETUQ=?from=profile"
											class="MainResume-edit"> <span
											class="SvgIcon_SvgIcon__root"> <svg
													class="SvgIcon_SvgIcon__root__svg">
                                                    <path
							...
							<div class="FormBlock-content content">
								<div class="EnterInterestArea-fieldset">
									...
									<div class="Static_className">
										...
										<div class="Static-body">MySQL, CSS, HTML, Java,
											JavaScript, Oracle Database</div>
									</div>
									<a
										href="https://www.wanted.co.kr/profile/matching?level=2&step=1&modi=true"
										class="EnterInterestArea-edit"> <span
										class="SvgIcon_SvgIcon__root"> <svg
												class="SvgIcon_SvgIcon__root__svg">
                                                <path
													fill-rule="evenodd" clip-rule="evenodd"
						...
						<div class="FormBlock Block_className">
							<div class="FormBlock-content content">
								<div class="AdditionalForm_className">
									...
									<div
										class="InputGroup InputGroup_className JobSearchIntentionSelector_className">
										...
										<div class="InputGroup-body">
											...
											<span class="JobSearchIntentionSelector-status"> 이력서
												공개중 </span>
											<p class="JobSearchIntentionSelector-status desc-text">기업으로부터
												면접 제안을 받으실 수 있습니다.</p>
										</div>
									</div>
								</div>
