...
<body>
    ...
    <div class="KakaoBanner_kakaoBanner">
        <div class="KakaoBanner_bannerWrapper">
            <div class="KakaoBanner_bannerContent">
                <!-- <img src="https://static.wanted.co.kr/images/kakao_icon.png" alt="kakao_icon"> -->
                <p></p>
            </div>
    ...
    <section class="MyWanted_MyWanted">
        <h2 class="MyWanted_MyWanted_title">MY Replace</h2>
                ...
                <div class="Aside_Aside_contents">
                    <div class="Aside_Profile">
                        ...
                        <div class="Aside_InterestTags">
                            <a href="https://www.wanted.co.kr/profile/interests" class data-attribute-id="myWanted__interestEdit">
                                <p>
                                    <em>관심태그</em>
                                    <span class="Aside_InterestTags1">IT/기술, 커리어고민, 개발, 취업/이직, 서비스기획, 인간관계, 회사생활</span>
                                </p>
                    ...
                    <!-- <div class="Aside_Point">
                        <a href="https://www.wanted.co.kr/profile/point">
                            <span>포인트</span>
                            <strong>0P</strong>
                        </a>
                    </div> -->
                    ...
                    <div class="Aside_MatchupStatus">
                        ...
                        <div class="Aside_MatchupStatus_container">
                            <a href="https://www.wanted.co.kr/profile/status?type=matchup-likes" class data-attribute-id="myWanted__matchupStatus">
                                <span>
                                    북마크
                                    <button type="button">
                                        <svg class="Aside_MatchupStatus_container_infoIcon" width="15" height="15" viewBox="0 0 24 24">
                                            <g fill="#aaa" fill-rule="evenodd">
                                                <path fill-rule="nonzero" d="M15.266 20.658A9.249 9.249 0 0112 21.25a9.25 9.25 0 010-18.5 9.21 9.21 0 016.54 2.71A9.217 9.217 0 0121.25 12a9.213 9.213 0 01-2.71 6.54.75.75 0 101.061 1.062A10.713 10.713 0 0022.75 12c0-2.89-1.146-5.599-3.149-7.601A10.717 10.717 0 0012 1.25C6.063 1.25 1.25 6.063 1.25 12S6.063 22.75 12 22.75c1.31 0 2.591-.235 3.794-.688a.75.75 0 10-.528-1.404z"></path>
                    ...
                    <div class="Aside_Setting">
                        <a href="https://www.wanted.co.kr/profile/settings?type=referral" class>계정 설정</a>
                    </div>
                </div>
            ...
            <section class="Body_Body">
                <div class="Summary_Summary">
                    ...
                    <ul class="Summary_Summary_status">
                        ...
                        <li>
                            <a href="https://www.wanted.co.kr/status/applications?status=pass&q&start_date=&end_date=" class>
                                <em class>3</em>
                                <span>서류 통과</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.wanted.co.kr/status/applications?status=hire&q&start_date=&end_date=" class>
                                <em class>2</em>
                                <span>최종 합격</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.wanted.co.kr/status/applications?status=reject&q&start_date=&end_date=" class>
                                <em class>2</em>
                                <span>불합격</span>
                            </a>
                        </li>
                    ...
                    <div class="ProfileLevel_ProfileLevel">
                        <div class="ProfileLevel_top">
                            <h2 class="ProfileLevel_title">
                                프로필
                                        <span class="Badge_Badge" style="background-color: rgb(51, 102, 255); width: 16px; height: 16px;">
                                ...
                                <div class="ProgressBar_profile">
                                    <h3 class="ProgressBar_levelTitle">
                                        <span class="ProgressBar_levelQuestion">신입, 웹 개발자
                                        </span>
                                    </h3>
                                    <div class="ProgressBar_progress">
                                        ...
                                        <button type="button"class="ProgressBar_profileLevel ProgressBar_levelStar">
                                            <svg width="12" height="12" viewBox="0 0 12 11" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
                                                <defs>
                                                    <path d="M11.516 4.631a1.337 1.337 0 0 0-1.056-.908l-2.23-.37-1.04-2.006a1.341 1.341 0 0 0-2.382 0L3.77 3.353l-2.23.37c-.496.083-.9.43-1.056.909-.156.478-.034.998.32 1.357l1.585 1.61-.336 2.232c-.076.498.13.99.536 1.287a1.339 1.339 0 0 0 1.391.115L6 10.223l2.022 1.011A1.34 1.34 0 0 0 9.947 9.83l-.334-2.156a1.028 1.028 0 0 1-.006-.056l1.591-1.628c.352-.36.474-.88.318-1.357"id="levelStar1"></path>
                                                </defs>
                                                <g fill="none" fill-rule="evenodd">
                                                    <mask id="levelStar2" fill="#fff">
                                                        <use xlink:href="#levelStar1"></use>
                                                    </mask>
                                                    <use fill="#E1E2E3" xlink:href="#levelStar1"></use>
                                                    <g mask="url(#levelStar2)" fill="#E1E2E3">
                                ...
                                <p class="LevelButtons_subtitle">400자만 채워주시면, 서류 합격률 높은 자리를 알려드려요!</p>
                                <div class="LevelButtons_button__wrapper">
                                    <button class="Button_Button__root Button_Button__outlined Button_Button__outlinedPrimary Button_Button__outlinedSizeMedium LevelButtons_button">
                                        <span class="Button_Button__label">매치업 이력서 채우고 자리 추천받기</span>
                                        <span class="Button_Button__interaction"></span>
                                    </button>
                                </div>
                            </div>
                            <aside class="CareerConnectBanner_CareerConnectBanner ProfileLevel_CareerConnectBanner">
                                <picture>
                                    <source srcset="https://static.wanted.co.kr/career_connect/banner-back-mobile-common.webp" type="image/webp">
                                    <img src="https://static.wanted.co.kr/images/events/2989/ca6eb878.jpg" alt="career-connect-icon">
                                </picture>
                                <button type="button" class="CareerConnectBanner_CareerConnectBanner__Banner">
                                    <div class="CareerConnectBanner_CareerConnectBanner__Banner__Content">
                                        <p>내 연차에 이 연봉 괜찮은가? 궁금할 땐</p>
                                        <strong>커리어 중간점검</strong>
                                        <picture>
                                            <source srcset="https://static.wanted.co.kr/career_connect/gomin.webp">
                                            <img src="https://static.wanted.co.kr/career_connect/gomin.webp" alt="career-connect-icon">
                                        </picture>
                                    </div>
                                </button>
                            </aside>
