<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                ...
                <div class="divCenterBox">
                    ...
                    <div class="bodybox">
                        <div class="formbox">
                            ...
                            <span class="logotext"> 리플레이스 기업서비스</span>
                            ...
                            <div class="div3">
                                ...
                                <div class="allagree agree">
                                    <div class="all">
                                        ...
                                        <div class="checkBox1">
                                            <p class="agreeText">리플레이스 기업 서비스 이용약관 동의 (필수)</p>
                                        </div>
                                ...
                                <div class="concurrenceContainer">
                                    <label class="concurrenceLabel">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                            viewBox="0 0 32 32">
                                            <path d="M4 16.304 12.33 24 28 8" stroke="#C4C4C4" stroke-width="3"
                                                fill="none" fill-rule="evenodd" stroke-linecap="round"
                                                stroke-linejoin="round" class="media1"></path>
                                        </svg>
                                    ...
                                    <label class="concurrenceLabel">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                            ...
                                            <path d="M4 16.304 12.33 24 28 8" stroke="#C4C4C4" stroke-width="3"
                                                fill="none" fill-rule="evenodd" stroke-linecap="round"
                                                stroke-linejoin="round" class="media2"></path>
                                        </svg>
                                    ...
                                    <label class="concurrenceLabel">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                            ...
                                            <path d="M4 16.304 12.33 24 28 8" stroke="#C4C4C4" stroke-width="3"
                                                fill="none" fill-rule="evenodd" stroke-linecap="round"
                                                stroke-linejoin="round" class="media3"></path>
                                        </svg>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.mediacheck1').change(function () {
                if ($(this).is(':checked')) {
                    $('.media1').css('stroke', '#3366ff');
                } else {
                    $('.media1').css('stroke', '#C4C4C4');
                }
            });
            $('.mediacheck2').change(function () {
                if ($(this).is(':checked')) {
                    $('.media2').css('stroke', '#3366ff');
                } else {
                    $('.media2').css('stroke', '#C4C4C4');
                }
            });
            $('.mediacheck3').change(function () {
                if ($(this).is(':checked')) {
                    $('.media3').css('stroke', '#3366ff');
                } else {
                    $('.media3').css('stroke', '#C4C4C4');
                }
            });
