                ...
                <div class="formbox">
                    <form>
                        ...
                        <div>
                            ...
                            <!-- 입력받은 이메일을 가져옴 -->
                            <input type="email" placeholder="" name="email" class="input" value="kangminjun99@gmail.com"
                                disabled="">
                        </div>
                        <!-- 이름 -->
                        <div>
                        ...
                        <div>
                            ...
                            <div class="telinputBox">
                                <input type="text" class="telinput" name="tel" placeholder="(예시)01013245768"><button
                                    class="telinputButton">인증번호 받기</button>
                            </div>
                            <input type="text" class="input" placeholder="인증번호를 입력해주세요.">
                        ...
                        <div class="all">
                            ...
                            <div class="checkBox1">
                                <p class="formStyle">원티드 이용약관 동의 (필수)</p>
                            </div>
                            <div>
                        ...
                        <div class="all">
                            ...
                            <div class="checkBox1">
                                <p class="formStyle">원티드 개인정보 수집 및 이용 동의 (필수)
                                <p>
                            </div>
                            <div>
...
<script>
    $(document).ready(function () {
        ...
        //         $(".telinput").css("background-color", "red");
        //     } else {
