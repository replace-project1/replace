...
<body>
	<script type="text/javascript"
		...
		$(".MainBar_hamberger").mouseover(function() {
			$(".OverlayJobCategory_Container").css("display", "block");
		});
		$(".Explore_Container").mouseout(function() {
		...
		<div class="MainBar_MainBar">
			<nav class="MainBar_MainBar_nav">
				...
				<ul class="Menu_className">
					<li class=""><a href="https://www.wanted.co.kr/wdlist"
						class="">채용</a></li>
					<li class=""><a href="https://www.wanted.co.kr/events"
						class="">이벤트</a></li>
					<li class="smMoreVisible"><a
						href="https://www.wanted.co.kr/cv/list" class="">이력서</a></li>
					<li class="smMoreVisible"><a
						href="https://www.wanted.co.kr/community" class="">커뮤니티</a></li>
					<li class="smMoreVisible"><a
						href="https://www.wanted.co.kr/gigs/experts" class="">프리랜서</a></li>
					<li class="smMoreVisible"><a
						href="https://www.wanted.co.kr/aiscore/resume" class="">AI
							합격예측</a></li>
				</ul>
                    ...
                    <g fill="none" fill-rule="evenodd">
                      <use fill="#333" fill-rule="nonzero" stroke="#333"
						...
						<li class="mdMoreVisible leftDivision"><a
							class="dashboardButton" href="https://www.wanted.co.kr/dashboard">기업
								서비스</a></li>
				...
				<div>
					<div class="Explore_Container">
						<section class="Explore_MainCategory">
							<a href="https://www.wanted.co.kr/wdlist" class=""> <em><h2>직군
										전체</h2></em>
							</a>
							<ul>
						...
						<section class="Explore_SubCategory">
							<ul>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/"
									class="">개발 전체</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z">
                      </path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/873"
									class="">웹 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z">
                      </path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/872"
									class="">서버 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z">
                      </path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10110" class="">소프트웨어 엔지니어</a> <svg
										width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z">
                      </path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/669"
									class="">프론트엔드 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
								...
								<li class="Explore_CategoryItem"><a href="/wdlist/518/660"
									class="">자바 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/900"
									class="">C,C++ 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/899"
									class="">파이썬 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/677"
									class="">안드로이드 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/895"
									class="">Node.js 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/1634"
									class="">머신러닝 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/678"
									class="">iOS 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/655"
									class="">데이터 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/674"
									class="">DevOps / 시스템 관리자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/665"
									class="">시스템,네트워크 관리자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/877"
									class="">개발 매니저</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/1026"
									class="">기술지원</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/1024"
									class="">데이터 사이언티스트</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/676"
									class="">QA,테스트 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/671"
									class="">보안 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/658"
									class="">임베디드 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/1025"
									class="">빅데이터 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/876"
									class="">프로덕트 매니저</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/672"
									class="">하드웨어 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/893"
									class="">PHP 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10111" class="">크로스플랫폼 앱 개발자</a> <svg
										width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/1027"
									class="">블록체인 플랫폼 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10231" class="">DBA</a> <svg width="10"
										height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10230" class="">ERP전문가</a> <svg width="10"
										height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/939"
									class="">웹 퍼블리셔</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/661"
									class="">.NET 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/896"
									class="">영상,음성 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/795"
									class="">CTO,Chief Technology Officer</a> <svg width="10"
										height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/898"
									class="">그래픽스 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10112" class="">VR 엔지니어</a> <svg width="10"
										height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/1022"
									class="">BI 엔지니어</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/894"
									class="">루비온레일즈 개발자</a> <svg width="10" height="10"
										class="Explore_CategoryItem_Icon" viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
								<li class="Explore_CategoryItem"><a href="/wdlist/518/793"
									class="">CIO,Chief Information Officer</a> <svg width="10"
										height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
	...
	<main>
		<section class="Section_Section">
				...
				<div class="slick-slider slick-initialized" dir="ltr">
					...
					<div class="slick-list" style="padding: 0px 50px">
						<div class="slick-track"
							...
							<div data-index="-2" class="slick-slide slick-cloned"
								style="width: 970px">
								<div>
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/themes/major"> <img
												...
												alt="주요 대기업 포지션 모음" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/7234"> <img
												...
												alt="블록체인 개발 전직군 채용 중" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/3118"> <img
												...
												alt="AI콘텐츠 제작 플랫폼 로보코리아" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/1571"> <img
												...
												alt="디자인도 논리가 필요하니까" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/34893"> <img
												...
												alt="기업용보안 솔루션 개발 '샌즈랩'" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/7810"> <img
												...
												alt="서비스 기획, UX/UI 디자인 채용 중" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/8"> <img
												...
												alt="채널톡은 글로벌 성장 중" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
							...
							<div class="slick-slide" style="outline: none; width: 970px">
								<div>
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="https://insight.wanted.co.kr/" target="_blank">
												<img
												...
												alt="연봉, 면접 등 기업정보를 한번에" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
							...
							<div class="slick-slide" style="outline: none; width: 970px">
								<div>
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/events/office_introduction"> <img
												...
												alt="우리 회사 오피스 자랑대회" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/themes/newposition"> <img
												...
												alt="이번 주 신규 포지션" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/themes/babyunicorn"> <img
												...
												alt="2023 아기 유니콘 기업" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
							...
							<div class="slick-slide" style="outline: none; width: 970px">
								<div>
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/events/secondoffice"> <img
												...
												alt="해외 개발자 원격 채용" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/34277"> <img
												...
												alt="삶을 반짝이게 만드는 벅찬 순간" class="Image_Image__image" />
											</a>
										</div>
									</div>
								</div>
			...
			<aside class="LineBanner_LineBanner">
				<a href="">
					<div class="LineBanner_LineBanner__link">
						<div
							class="LineBanner_LineBanner__box LineBanner_LineBanner__gradient">
							<svg xmlns="https://www.w3.org/2000/svg"
								xmlns:xlink="https://www.w3.org/1999/xlink" width="28"
								height="28" viewBox="0 0 18 18">
                  <defs>
                    <path id="qt2dnsql4a"
									d="M15.727 17.273a.563.563 0 10.796-.796l-4.875-4.875-.19-.165a.563.563 0 00-.764.028 5.063 5.063 0 111.261-2.068.562.562 0 101.073.338 6.188 6.188 0 10-1.943 2.894l4.642 4.644z">
                    </path>
                  ...
                  <g fill="none" fill-rule="evenodd">
                    <use fill="#fff" fill-rule="nonzero" stroke="#fff"
				...
				<div class="CompanyChart_container">
					<div class="MainTitle_title-wrap">
						<div class="MainTitle_title-text">
							<span
								class="Typography_typography Typography_typography--B1 Typography_typography--medium">
								기업목록 </span> <a href="../main/companyList.jsp"
								class="Typography_typography Typography_typography--B1 Typography_typography--medium More-View">
								+더보기 </a>
						</div>
					</div>
					<div
						class="RecruitMainCardList_container RecruitMainCardList_fourRow RecruitMainCardList_platinumvip RecruitMainCardList_isBoxShadow">
						<div>
							<div class="RecruitMainCardList_card-wrap">
								...
								<div class="RecruitMainCardList_card-content">
									<div class="RecruitMainCardList_company-img-logo-wrap">
										<span class="Image_custom-image Image_custom-image--intrinsic">
											<img
											src="https://img.albamon.kr/trans/150x60/2020-08-21/e31du74k1jai3zj.gif"
											class="" loading="lazy" alt="30초 간편지원/물류관리자 성장 기업 사이드로고">
										</span>
									</div>
									<div class="RecruitMainCardList_company-name-wrap">
										<span
											class="Typography_typography Typography_typography--B3 Typography_typography--regular">
											제목 </span>
									</div>
									...
									<div class="RecruitMainCardList_card-footer-wrap">
										<span
											class="Typography_typography Typography_typography--B3 Typography_typography--regular">
											서울특별시(주소) <span class="RecruitMainCardList_card-footer-dot">
												· </span> <span style="color: rgb(0, 161, 239);"> 연 </span> <span
											class="RecruitMainCardList_salary-wrap"> <strong
												class="Typography_typography Typography_typography--B3 Typography_typography--bold">
													(가격) </strong> <span
												class="Typography_typography Typography_typography--B3 Typography_typography--medium">
													원 </span>
										</span>
										</span>
									</div>
		...
		<footer class="Footer_footerClass">
			<div class="Footer_rowClass">
				<div class="NavLinks_NavLinks">
					<a class="NavLinks_NavLinks__logo"
						href="https://www.wanted.co.kr/jobsfeed"> <svg width="31.4%"
							height="100%" viewBox="0 0 79 32">
                <path fill="#24e0a6"
              ...
              </svg> <svg width="62.96%" height="100%" viewBox="0 0 140 32">
                <path fill="currentColor"
								d="M89.8 2.2l-5.6 2.4v4.8h-3.8v5.2h3.8v10.2c0 4.2 2.6 7 6.6 7 1.6 0 2.6-.4 3.2-.6V26c-.2 0-1 .2-1.8.2-1.6 0-2.4-.6-2.4-2.6v-8.8H94V9.6h-4.2V2.2zM28.6 9.6l-4 14-4.6-14h-5.6l-4.6 14L6 9.6H0l6.8 21.8h6l4.4-14.6 4.6 14.6h6l6.8-21.8zM134.4 2.2v8.6c-1.4-1-3-1.6-4.8-1.8h-.4-1.6c-5 .4-8.2 4.2-9.2 9-.2.8-.2 1.4-.2 2.2V22c.6 5.6 4.4 10 10.2 10 2.4 0 4.4-.6 6-1.8v1.4h5.4V0l-5.4 2.2zm-5.2 24.4c-3 0-5.6-2.4-5.6-6.2 0-4 2.6-6.2 5.6-6.2s5.2 2.2 5.2 6c0 4.2-2.2 6.4-5.2 6.4zM116.2 18c-.8-5.2-4.6-9-10-9s-9.2 3.8-10 9c-.2.8-.2 1.6-.2 2.6v1.6c.6 5.6 4.4 10 10.2 10 4.6 0 8-2.8 9.4-6.8l-5-1.2c-.8 1.8-2.4 3.2-4.4 3.2-2.8 0-4.6-2.2-5-5.2h15.2v-1.6c0-1 0-1.8-.2-2.6zm-14.8 0c.8-2.2 2.4-3.6 4.8-3.6s4 1.6 4.8 3.6h-9.6zM50.6 11c-1.4-1-3.2-1.8-5.2-1.8H44.8h-.6c-5.2.4-8.6 4-9.4 9-.2.8-.2 1.4-.2 2.2v1.8c.6 5.6 4.4 10 10.2 10 2.4 0 4.4-.6 6-1.8v1.4h5.6V9.6h-5.6V11zm-5.2 15.6c-3 0-5.6-2.4-5.6-6.2 0-4 2.6-6.2 5.6-6.2s5.2 2.2 5.2 6c0 4.2-2.2 6.4-5.2 6.4zM71.2 9c-2.2 0-4.6 1-6 3.2V9.6h-5.6v21.8h5.6V18.8c0-2.6 1.4-4.6 4-4.6 2.8 0 3.8 2 3.8 4.4v12.8h5.6V17.6c.2-4.8-2.2-8.6-7.4-8.6z"></path>
              </svg>
					</a>
					<div class="NavLinks_NavLinks__links">
						<a href="https://www.wantedlab.com/" class="" target="_blank">Q&A
						</a> <a href="https://help.wanted.co.kr/hc/ko/" class=""
                ...
                target="_blank"
                >원티드 블로그</a> -->
						<a href="https://www.wanted.co.kr/terms" class="" target="_blank">이용약관
						</a> <a href="https://www.wanted.co.kr/privacy" class=""
							target="_blank"> <b>개인정보 처리방침</b>
						</a>
					</div>
				</div>
				<div class="SocialLinks_SocialLinks">
					<a href="https://www.instagram.com/wantedjobs.kr/" class=""
						target="_blank"> <img
						...
						alt="youtube" />
					</a> <a href="https://www.facebook.com/wantedkr" class=""
						target="_blank"> <img
						...
						alt="facebook" />
					</a> <a href="https://blog.naver.com/wantedlab" class=""
						target="_blank"> <img
						...
						alt="blog" /></a> <a
						href="https://apps.apple.com/kr/app/id1074569961" class=""
						target="_blank"> <img
			...
			<div class="Footer_rowClass Footer_border">
				<p class="Footer_footerText kr">
					...
					2020-서울송파-3147<br />유료직업소개사업등록번호 : (국내) 제2020-3230259-14-5-00018호
