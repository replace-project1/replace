	...
	<div class="NavBar_className"
		...
		<div class="MainBar_MainBar">
				...
				<div class="MainBar_MainBar_nav_top">
					<div class="MainBar_MainBar_nav_top_logo">
						...
						<a href="https://www.wanted.co.kr/jobsfeed"
							class="MainBar_MainBar_logo"> <img
							src="../static/images/logo_garo.png" width="100%" height="40px"
							viewBox="0 0 140 32"> <!--             <svg width="74" height="21" viewBox="0 0 140 32">
                  <path
                    fill="currentColor"
			...
			<div class="OverlayJobCategory_Container"
				id="OverlayJobCategory_Container">
				<div>
					<div class="Explore_Container">
                      ...
                      <path fill="#3366FF"
								...
								<li class="Explore_CategoryItem"><a href="/wdlist/518/660"
									class="">자바 개발자</a>
								<svg width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                    </svg></li>
                      ...
                      <path fill="#3366FF"
								...
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10111" class="">크로스플랫폼 앱 개발자</a>
								<svg width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                      ...
                      <path fill="#3366FF"
								...
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10231" class="">DBA</a>
								<svg width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
								...
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10230" class="">ERP전문가</a>
								<svg width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                      ...
                      <path fill="#3366FF"
								...
								<li class="Explore_CategoryItem"><a href="/wdlist/518/795"
									class="">CTO,Chief Technology Officer</a>
								<svg width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                      ...
                      <path fill="#3366FF"
								...
								<li class="Explore_CategoryItem"><a
									href="/wdlist/518/10112" class="">VR 엔지니어</a>
								<svg width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
                      ...
                      <path fill="#3366FF"
								...
								<li class="Explore_CategoryItem"><a href="/wdlist/518/793"
									class="">CIO,Chief Information Officer</a>
								<svg width="10" height="10" class="Explore_CategoryItem_Icon"
										viewBox="0 0 12 12">
                      <path fill="#3366FF"
											d="M3.345 9.72a.75.75 0 0 0 1.06 1.06l4.25-4.25a.75.75 0 0 0 0-1.06l-4.25-4.25a.75.75 0 0 0-1.06 1.06L7.065 6l-3.72 3.72z"></path>
	...
	<main>
		<section class="Section_Section">
			<div class="TopBanner_TopBanner">
				<div class="slick-slider slick-initialized" dir="ltr">
					...
					<div class="slick-list" style="padding: 0px 50px">
						<div class="slick-track" id="slide-track"
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/34893"> <img
												...
												alt="기업용보안 솔루션 개발 '샌즈랩'" class="Image_Image_image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/themes/major"> <img
												...
												alt="주요 대기업 포지션 모음" class="Image_Image_image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/7234"> <img
												...
												alt="블록체인 개발 전직군 채용 중" class="Image_Image_image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/3118"> <img
												...
												alt="AI콘텐츠 제작 플랫폼 로보코리아" class="Image_Image_image" />
											</a>
										</div>
									</div>
								</div>
									...
									<div style="width: 100%; display: inline-block">
										<div class="Image_Image">
											<a href="/company/1571"> <img
												...
												alt="디자인도 논리가 필요하니까" class="Image_Image_image" />
											</a>
										</div>
									</div>
								</div>
			...
			<aside class="LineBanner_LineBanner">
				...
				<!-- 미구현 페이지 이동 -->
				<a
					href="<%-- javascript:location.href='${pageContext.request.contextPath}/write.board' --%>">
					<div class="LineBanner_LineBanner_link">
						<div
							class="LineBanner_LineBanner_box LineBanner_LineBanner_gradient">
							<svg xmlns="https://www.w3.org/2000/svg"
				...
				<div class="CompanyChart_container">
					<div class="MainTitle_title-wrap">
						<div class="MainTitle_title-text">
							<span
								class="Typography_typography Typography_typography_B1 Typography_typography_medium">
								기업목록 </span> <a href="../company-list/companyList.jsp"
								class="Typography_typography Typography_typography_B1 Typography_typography_medium More-View">
								+더보기 </a>
						</div>
					</div>
					<div
								...
								<a href="../company-detail/company-detail.jsp">
									...
									<div class="RecruitMainCardList_card-content">
										...
										<div class="RecruitMainCardList_company-name-wrap">
											<span
												class="Typography_typography Typography_typography_B3 Typography_typography_regular">
												제목 </span>
										</div>
										...
										<div class="RecruitMainCardList_card-footer-wrap">
											<span
												...
												class="RecruitMainCardList_salary-wrap"> <strong
													class="Typography_typography Typography_typography_B3 Typography_typography_bold">
														(가격) </strong> <span
													class="Typography_typography Typography_typography_B3 Typography_typography_medium">
														원 </span>
											</span>
											</span>
										</div>
		...
		<footer class="Footer_footerClass">
			<div class="Footer_rowClass">
				<div class="NavLinks_NavLinks">
					<a class="NavLinks_NavLinks_logo"
						href="https://www.wanted.co.kr/jobsfeed"> <img
						src="../static/images/logo_garo.png" width="100%" height="100%">
              ...
              <svg width="62.96%" height="100%" viewBox="0 0 140 32">
				...
				<div class="SocialLinks_SocialLinks">
					<a href="https://www.instagram.com/wantedjobs.kr/" class=""
						...
						alt="blog" /></a> <a href="https://apps.apple.com/kr/app/id1074569961"
						class="" target="_blank"> <img
